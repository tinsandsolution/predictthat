...
def seed_markets():
    ...
    markets = [
        ...
        Market(manager_id='2', image_url='https://i.imgur.com/Xsh4lDn.png', is_in_play = True, short_title='Lara Hired', title='Will Lara have a job that pays more than $50k a year by February 2, 2023?', description='Confirmation of this will be determined by a screenshot of Lara Duong\'s slack message.'),
