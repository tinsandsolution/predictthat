...
def seed_markets():
    ...
    goodMarkets = [
        ...
        Market(manager_id='2', image_url='https://i.imgur.com/Xsh4lDn.png', short_title='Standard Duong Passing', title='Will Standard pass the capstone project on the first try?', description='Confirmation of this will be determined by a screenshot of a slack message from at least one TA'),
    ]
    ...
    markets = [
        ...
        Market(manager_id='2', image_url='https://i.imgur.com/Xsh4lDn.png', is_in_play = True, short_title='Standard Hired', title='Will Standard have a job that pays more than $50k a year by February 2, 2023?', description='Confirmation of this will be determined by a screenshot of Standard Duong\'s slack message.'),
        ...
        Market(manager_id='3', image_url='https://i.imgur.com/Uq03eZJ.png', short_title='Tom Bluher Capstone', title='Will Tom Bluher pass the capstone assessment on the first try?', description='Confirmation of this will be determined by a screenshot of a slack message from at least one TA'),
