...
def seed_markets():
    ...
    market8 = Market(manager_id='2', image_url='https://i.imgur.com/Xsh4lDn.png', is_in_play = True, short_title='Standard Hired', title='Will Standard have a job that pays more than $50k a year by February 2, 2023?', description='Confirmation of this will be determined by a screenshot of Standard Duong\'s slack message.')
    ...
    market10 = Market(manager_id='2', image_url='https://i.imgur.com/sGBZpe5.png', is_in_play = True, short_title='Hans Niemann Admission', title='Will Hans Niemann admit to cheating on an over-the-board game before 2024?', description='Confirmation of this will be determined by a WSJ, NYT, or CNBC article. ')
    ...
    market13 = Market(manager_id='1', image_url='https://i.imgur.com/MVNpjMV.png', is_in_play = True, short_title='An Bui Passing', title='Will An Bui pass the capstone project on the first try?', description='Confirmation of this will be determined by a screenshot of a slack message from at least one TA')
