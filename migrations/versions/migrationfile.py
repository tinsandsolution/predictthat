...
Revision ID: 71f61f69934b
Revises: 
Create Date: 2022-10-27 17:13:23.090550
...
def upgrade():
    ...
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('market_id', sa.Integer(), nullable=True),
    sa.Column('yes_shares', sa.Integer(), nullable=True),
